\begin{landscape}
	...
	\begin{table}[]
		...
		\begin{tabular}{c|c|c|c|c}
			...
			$\mathcal{U}_{[a,b]}; (a,b) \in \mathbb{R}^2$ & $\frac{1}{b-a} \indicator{a<x<b}$ & $\frac{a+b}{2}$ & $\frac{(b-a)^2}{12}$ & $\frac{e^{tb}-e^{ta}}{t(b-a)}$ \\ \hline \hline
		\end{tabular}%
		}%
